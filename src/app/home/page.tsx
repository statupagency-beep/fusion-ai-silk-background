...
import { Bot, Sparkles, Zap, Brain, Code, MessageSquare } from "lucide-react";
          ...
          {aiApps.map((app) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${app.gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="relative text-center py-20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#FF6B35] to-[#1E90FF] text-white font-medium hover:scale-105 transition-transform duration-300 shadow-lg shadow-[#FF6B35]/30">
                Explore More Apps
              </button>
